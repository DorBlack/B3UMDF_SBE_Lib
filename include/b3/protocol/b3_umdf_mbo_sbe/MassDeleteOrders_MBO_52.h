...
public:
    ...
    {
        return *this = MassDeleteOrders_MBO_52(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    MassDeleteOrders_MBO_52 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MassDeleteOrders_MBO_52(
            buffer,
    ...
    MassDeleteOrders_MBO_52 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MassDeleteOrders_MBO_52(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MassDeleteOrders_MBO_52 &_writer)
{
