...
public:
    ...
    {
        return *this = OpeningPrice_15(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    OpeningPrice_15 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = OpeningPrice_15(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, OpeningPrice_15 &_writer)
{
