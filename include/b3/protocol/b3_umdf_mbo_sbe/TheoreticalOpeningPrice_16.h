...
public:
    ...
    {
        return *this = TheoreticalOpeningPrice_16(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    TheoreticalOpeningPrice_16 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = TheoreticalOpeningPrice_16(
            buffer,
    ...
    TheoreticalOpeningPrice_16 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = TheoreticalOpeningPrice_16(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, TheoreticalOpeningPrice_16 &_writer)
{
