...
public:
    ...
    {
        return *this = Order_MBO_50(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    Order_MBO_50 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Order_MBO_50(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, Order_MBO_50 &_writer)
{
    Order_MBO_50 writer(
        _writer.m_buffer,
        _writer.m_offset,
