...
public:
    ...
    {
        return *this = DeleteOrder_MBO_51(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    DeleteOrder_MBO_51 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = DeleteOrder_MBO_51(
            buffer,
    ...
    DeleteOrder_MBO_51 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = DeleteOrder_MBO_51(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, DeleteOrder_MBO_51 &_writer)
{
