...
public:
    ...
    {
        return *this = ChannelReset_11(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ChannelReset_11 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ChannelReset_11(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ChannelReset_11 &_writer)
{
