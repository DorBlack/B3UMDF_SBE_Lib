...
public:
    ...
    {
        return *this = ExecutionSummary_55(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ExecutionSummary_55 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionSummary_55(
            buffer,
    ...
    ExecutionSummary_55 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionSummary_55(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ExecutionSummary_55 &_writer)
{
