...
public:
    ...
    {
        return *this = TradeBust_57(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    TradeBust_57 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = TradeBust_57(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, TradeBust_57 &_writer)
{
    TradeBust_57 writer(
        _writer.m_buffer,
        _writer.m_offset,
