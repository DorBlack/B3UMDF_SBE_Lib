...
public:
    ...
    {
        return *this = SequenceReset_1(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    SequenceReset_1 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = SequenceReset_1(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SequenceReset_1 &_writer)
{
