...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(48);
    ...
    {
        return *this = PriceBand_20(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    PriceBand_20 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = PriceBand_20(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, PriceBand_20 &_writer)
{
    PriceBand_20 writer(
        _writer.m_buffer,
        _writer.m_offset,
