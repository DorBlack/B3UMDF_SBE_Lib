...
public:
    ...
    {
        return *this = ForwardTrade_54(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ForwardTrade_54 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ForwardTrade_54(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ForwardTrade_54 &_writer)
{
