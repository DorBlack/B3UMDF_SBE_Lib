...
public:
    ...
    {
        return *this = ClosingPrice_17(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ClosingPrice_17 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ClosingPrice_17(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ClosingPrice_17 &_writer)
{
