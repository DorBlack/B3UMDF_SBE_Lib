...
public:
    ...
    {
        return *this = LowPrice_25(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    LowPrice_25 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = LowPrice_25(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, LowPrice_25 &_writer)
{
    LowPrice_25 writer(
        _writer.m_buffer,
        _writer.m_offset,
