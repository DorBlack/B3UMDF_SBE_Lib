...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(71);
    ...
    {
        return *this = SnapshotFullRefresh_Orders_MBO_71(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    SnapshotFullRefresh_Orders_MBO_71 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotFullRefresh_Orders_MBO_71(
            buffer,
    ...
    SnapshotFullRefresh_Orders_MBO_71 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefresh_Orders_MBO_71(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotFullRefresh_Orders_MBO_71 &_writer)
{
