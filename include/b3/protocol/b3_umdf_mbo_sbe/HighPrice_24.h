...
public:
    ...
    {
        return *this = HighPrice_24(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    HighPrice_24 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = HighPrice_24(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, HighPrice_24 &_writer)
{
    HighPrice_24 writer(
        _writer.m_buffer,
        _writer.m_offset,
