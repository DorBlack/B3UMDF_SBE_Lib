...
public:
    ...
    {
        return *this = Trade_53(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    Trade_53 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Trade_53(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, Trade_53 &_writer)
{
    Trade_53 writer(
        _writer.m_buffer,
        _writer.m_offset,
