...
public:
    ...
    {
        return *this = EmptyBook_9(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    EmptyBook_9 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = EmptyBook_9(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, EmptyBook_9 &_writer)
{
    EmptyBook_9 writer(
        _writer.m_buffer,
        _writer.m_offset,
