...
public:
    ...
    {
        return *this = QuantityBand_21(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    QuantityBand_21 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = QuantityBand_21(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, QuantityBand_21 &_writer)
{
