...
public:
    ...
    {
        return *this = AuctionImbalance_19(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    AuctionImbalance_19 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = AuctionImbalance_19(
            buffer,
    ...
    AuctionImbalance_19 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = AuctionImbalance_19(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, AuctionImbalance_19 &_writer)
{
