...
public:
    ...
    {
        return *this = ExecutionStatistics_56(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ExecutionStatistics_56 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionStatistics_56(
            buffer,
    ...
    ExecutionStatistics_56 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionStatistics_56(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ExecutionStatistics_56 &_writer)
{
